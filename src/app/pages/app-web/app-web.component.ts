...
export class AppWebComponent implements OnInit {
        ...
        (data: any) => {
          ...
          if (data && data.status === 200) {
            if (data && data.data && data.data.length) {
              ...
              this.an_bank = info.an_bank;
              this.qrisImage = info.qris;
              this.ket_pengiriman = info.ket_pengiriman;
            }
          } else {
            this.haveSave = false;
          }
  ...
  submit() {
    ...
    if (this.qrisImage === "" || !this.qrisImage) {
      this.error(this.api.translate("Please add qris image"));
      return false;
    }
    ...
    if (this.haveSave) {
      ...
      const param = {
        ...
        qris: this.qrisImage,
        ket_pengiriman: this.ket_pengiriman,
      };

      console.log("param", param);
      this.spinner.show();
      this.api
        .post("general/editList", param)
        .then(
          (data: any) => {
